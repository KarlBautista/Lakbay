    ...
    <div className='min-h-screen w-full bg-gradient-to-br from-[#F0F6FF] via-white to-[#E8F4FD] flex items-center justify-center p-4'>
      ...
      <div className='relative w-full max-w-md'>
        ...
        <div className='bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 overflow-hidden'>
          ...
          {/* Header Section */}
          <div className='bg-gradient-to-r from-[#0A2A60] to-[#1a4088] px-8 py-8 text-center relative'>
            <div className='absolute inset-0 bg-gradient-to-r from-[#FFDA3E]/10 to-transparent'></div>
          ...
          <div className='px-8 py-8'>
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <div className='flex items-center justify-between'>
                ...
                <a href="#" className='text-sm text-[#0A2A60] hover:text-[#1a4088] font-medium transition-colors'>
                  Forgot password?
                </a>
              </div>
              ...
              <button
                type="submit"
                className='w-full bg-gradient-to-r from-[#0A2A60] to-[#1a4088] hover:from-[#1a4088] hover:to-[#2d5aa8] text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl'
              >
